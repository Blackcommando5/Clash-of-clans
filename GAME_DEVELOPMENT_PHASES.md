...
| 7. Complete attack loop | Partial | Latest 20 persistent campaign summaries and verified saved replay playback; eight-step resumable guide; four authored campaign missions, committed army, saved results/progress, once-only first-clear rewards; practice scouting/start, surrender, stars/results and replay | Interrupted combat resumption and phone validation |
