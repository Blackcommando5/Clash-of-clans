...
| 7. Complete attack loop | Partial | Four authored campaign missions, committed army, saved results/progress, once-only first-clear rewards; practice scouting/start, surrender, stars/results and replay | Guided/resumable tutorial, battle history, interrupted combat resumption and phone validation |
