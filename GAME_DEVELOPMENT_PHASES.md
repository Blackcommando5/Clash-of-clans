...
| 7. Complete attack loop | Partial | Eight-step resumable guide; four authored campaign missions, committed army, saved results/progress, once-only first-clear rewards; practice scouting/start, surrender, stars/results and replay | Battle history, interrupted combat resumption and phone validation |
